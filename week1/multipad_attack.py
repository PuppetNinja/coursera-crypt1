...
msg_list = {msg1, msg2, msg3, msg4, msg5, msg6, msg7, msg8, msg9, msg10}

target_msg = "32510ba9babebbbefd001547a810e67149caee11d945cd7fc81a05e9f85aac650e9052ba6a8cd8257bf14d13e6f0a803b54fde9e77472dbff89d71b57bddef121336cb85ccb8f3315f4b52e301d16e9f52f904"

# get the string with the shortest length
sorted_msg_list=sorted(msg_list, key=lambda msg: len(msg))
